    ...
    <section className="vpAddPlacePreview map-control-overlay" aria-label="Adicionar Lugar">
      <div className="vpAddPlacePanelFrame">
        ...
        >
          ...
          <section className="vpAddPlaceFormCard" aria-label="FormulÃ¡rio de lugar">
            <div className="vpAddPlaceGrid">
              ...
              <FieldShell
                label={
                  <>
                    ObservaÃ§Ãµes <small>(opcional)</small>
                  </>
                }
                className="vpAddPlaceFull"
              >
                <textarea
                  placeholder="Detalhes do acesso, marÃ© boa, iscas que funcionam, cuidados no local..."
                  value={notes}
          ...
          <footer className="vpAddPlaceFooter">
            <button className="vpAddPlacePrimaryButton" type="button">
              Salvar lugar aqui
            </button>

            <button className="vpAddPlaceCancelButton" type="button">
              Cancelar
            </button>
          </footer>
        </main>
