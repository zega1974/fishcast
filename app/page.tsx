  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden">
      <div className="absolute left-3 top-3 z-[600] sm:left-4 sm:top-4">
        <div className="flex max-w-[calc(100vw-24px)] items-center gap-2 rounded-2xl border border-cyan-500/20 bg-black/82 px-2.5 py-2 shadow-[0_12px_34px_rgba(0,0,0,0.42)] backdrop-blur-md sm:gap-3 sm:px-3">
